...
export const dictionary = {
  en: {
    ...
    form: {
      ...
      highestLevel: "Highest Level Taught",
      ...
      remove: "Remove",
      replace: "Replace",
      uploadUniId: "University ID Card Image",
      uploadNationalId: "National ID / Passport Image",
      uploadPhoto: "Personal Photo",
      uploadCert: "Supporting Certificate",
      uploadCv: "CV / Resume",
      uploadEmployeeId: "Employee ID Card",
      uploadTeachingCert: "Teaching Certificates",
      uploadExpCert: "Experience Certificates",
      // messages
      successStudent:
  ...
  ar: {
    ...
    form: {
      ...
      highestLevel: "أعلى مستوى درّستِه",
      instituteName: "اسم المعهد",
      experience: "سنوات الخبرة في التدريس",
      ...
      remove: "حذف",
      replace: "استبدال",
      uploadUniId: "صورة البطاقة الجامعية",
      uploadNationalId: "صورة الهوية / جواز السفر",
      uploadPhoto: "صورة شخصية",
      uploadCert: "شهادة داعمة",
      uploadCv: "السيرة الذاتية",
      uploadEmployeeId: "بطاقة الموظّف",
      uploadTeachingCert: "شهادات التدريس",
      uploadExpCert: "شهادات الخبرة",
