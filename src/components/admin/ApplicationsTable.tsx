    ...
    <div className="space-y-5">
      ...
      {kind === "visiting" && showCreate && (
        ...
        >
          ...
          {createError && (
            <p className="sm:col-span-2 lg:col-span-3 text-sm font-medium text-rose-600">
              {createError}
            </p>
          )}
...
const EDITABLE: Record<Kind, [string, string][]> = {
  ...
  student: [
    ...
    ["universityId", "University Registration No"],
    ["department", "Department"],
  ...
  const fields =
    kind === "visiting"
      ...
      ? [
          ...
          ["University Registration No", rec.universityId],
          ["Department", rec.department],
