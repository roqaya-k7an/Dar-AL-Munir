...
export const dictionary = {
  en: {
    ...
    join: {
      kicker: "Join Dar Al Muneerah",
      title: "How would you like to begin?",
      lead: "Choose the path that suits you. You can register as a student or apply to teach with us.",
      studentTitle: "Student Registration",
      studentDesc: "Enroll in the Qur'an, Tajweed, Hadith, Aqeedah and Islamic sciences.",
      instructorTitle: "Instructor Application",
      instructorDesc: "Apply to teach and share your knowledge with our students.",
      start: "Start",
    },
    about: {
    ...
    instructor: {
      ...
      lead: "Apply to teach with us. Fields marked with * are required.",
    },
    admin: {
  ...
  ar: {
    ...
    join: {
      ...
      lead: "اختاري المسار المناسب لكِ. يمكنكِ التسجيل كطالبة أو التقدّم للتدريس معنا.",
      studentTitle: "تسجيل الطالبات",
      studentDesc: "التحقي بدورات القرآن والتجويد والحديث والعقيدة والعلوم الإسلامية.",
      instructorTitle: "طلب التدريس",
      instructorDesc: "تقدّمي للتدريس وشاركي معرفتك مع طالباتنا.",
      start: "ابدئي",
    },
    about: {
      kicker: "عن دار منيرة",
    ...
    instructor: {
      title: "طلب التدريس",
      lead: "تقدّمي للتدريس معنا. الحقول المُعلَّمة بـ * إلزامية.",
    },
    admin: {
      login: "دخول المشرفة",
